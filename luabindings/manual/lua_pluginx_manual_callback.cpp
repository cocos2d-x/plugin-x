...
static void extendProtocolUser(lua_State* tolua_S)
{
    ...
    if (lua_istable(tolua_S,-1))
    {
        lua_pushstring(tolua_S,"login");
        lua_pushcfunction(tolua_S,lua_pluginx_protocols_ProtocolUser_login);
        lua_rawset(tolua_S,-3);
        lua_pushstring(tolua_S,"logout");
        lua_pushcfunction(tolua_S,lua_pluginx_protocols_ProtocolUser_logout);
        lua_rawset(tolua_S,-3);
    }
    lua_pop(tolua_S, 1);
}
